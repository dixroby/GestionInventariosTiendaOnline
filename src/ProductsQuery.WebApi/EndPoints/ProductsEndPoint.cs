...
public static class ProductsEndPoint
{
    public static IEndpointRouteBuilder MapProductsEndPoint(this IEndpointRouteBuilder app)
    {
        ...
        app.MapGet(Endpoints.GetProductByNameAndCategory, async (IProductsController controller, [FromQuery] ProductsDto request)
        => TypedResults.Ok(await controller.GetProductByNameAndCategory(request)));
